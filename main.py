...
OWNER_ID = 8144269730 # Replace with the actual owner's user ID
...
AUTH_CHANNEL = -1002411473528,-1002696899280
...
async def help_command(client: Client, msg: Message):
    help_text = (
        "`/start` - Start the bot⚡\n\n"
        "`/JB` - Download and upload files (sudo)🎬\n\n"
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            #url = f"https://madxapi-d0cbf6ac738c.herokuapp.com/{id}/master.m3u8?token={raw_text4}"
             ...
             url = f"https://anonymouspwplayer-b99f57957198.herokuapp.com/pw?url={url}?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..61VjZvxJ41fn0lTcw8Bwgi6dTn5sGmRm8bDTNai4ECE"
